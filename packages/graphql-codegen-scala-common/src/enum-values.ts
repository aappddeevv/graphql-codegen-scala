// copy from @graphql-codegen/visitor-plugin-common

//export { parseEnumValues } from "@graphql-codegen/visitor-plugin-common";

import {
  EnumValuesMap,
  ParsedEnumValuesMap,
  parseMapper,
  isExternalMapperType
      ...
      if (typeof pointer === "string") {
        ...
        return {
          ...
          [gqlIdentifier]: {
            ...
            sourceIdentifier: isExternalMapperType(mapper)
              ? mapper.import
              : mapper.type,
            mappedValues: null
          }
